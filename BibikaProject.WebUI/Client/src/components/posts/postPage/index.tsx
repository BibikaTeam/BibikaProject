    ...
    <div className="post-page-container">
      ...
      <div className="post-page-images">
        <div className="post-page-current-image">
          ...
          <svg onClick={onImagePrev} className="left-arrow" width="30" height="58" viewBox="0 0 30 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M27 3L4.53554 25.4645C2.58291 27.4171 2.58291 30.5829 4.53553 32.5355L27 55" stroke="white" stroke-opacity="0.5" stroke-width="5" stroke-linecap="round"/>
          </svg>
          <svg onClick={onImageNext} className="right-arrow" width="30" height="58" viewBox="0 0 30 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 3L25.4645 25.4645C27.4171 27.4171 27.4171 30.5829 25.4645 32.5355L3 55" stroke="white" stroke-opacity="0.5" stroke-width="5" stroke-linecap="round"/>
          </svg>
        </div>

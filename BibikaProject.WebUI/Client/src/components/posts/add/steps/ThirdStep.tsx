  ...
  return (
    <div className="steps-container">
      <div className="steps-body">
        <div className="steps-header">
          <div className="steps-title-container">
            <div className="steps-title">3. Your contacts</div>
            <div className="steps-description">
              &emsp; Enter the seller's contacts
            </div>
          </div>
        ...
        <div className="steps-map-container">
          Location
          <div className="steps-map-input">{address}</div>
      ...
      <div className="steps-footer">
        ...
        <div className="steps-footer-block-active">3. Specify contacts</div>
      </div>
    </div>
  );
};

  ...
  return (
    <div className="steps-container">
          ...
          <div className="steps-title-container">
            ...
            <div className="steps-container">
              <div className="steps-text">
                &emsp; There must be at least 3 photos
              </div>
            </div>
          </div>

          <div className="steps-actions">
            <Button className="steps-action-button-back" disabled={true}>
              Back
            </Button>
            <Button
              className="steps-action-button-done"
              onClick={() => {
                props.onFinish(images);
              }}
      ...
      <div className="steps-footer">
        <div className="steps-footer-block-active">1. Add photos</div>
        <div className="steps-footer-block">2. Provide information</div>
